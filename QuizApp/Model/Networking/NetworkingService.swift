...
class NetworkingService {
    ...
    @discardableResult
    func performRequest<D: Encodable, R: Decodable>(to endpoint: Endpoint, with jsonData: D, completion: @escaping (Swift.Result<R, Error>) -> Void) -> URLSessionDataTask {
    ...
    func performRequest<D: Encodable>(to endpoint: Endpoint, with jsonData: D, completion: @escaping (Error?) -> Void) -> URLSessionDataTask {
        ...
        return request(to: endpoint, with: data) { (_, _, error) in
            completion(error)
            return
        }
    }
    ...
    @discardableResult
    func performRequest<R: Decodable>(to endpoint: Endpoint, completion:  @escaping (Swift.Result<R, Error>) -> Void) -> URLSessionDataTask {
        print("Requesting \(endpoint)")

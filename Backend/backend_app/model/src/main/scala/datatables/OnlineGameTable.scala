...
class OnlineGameTable(tag: Tag) extends Table[OnlineGame](tag, "online_game") with BaseTable[OnlineGame] {
  ...
  val player1Id = column[Int]("player_one_id")
  ...
  def * = (id, gameRoomId, player1Id, player2Id, questionsList, answersPlayer1List, answersPlayer2List, winner) <> ((OnlineGame.apply _).tupled, OnlineGame.unapply)
